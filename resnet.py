...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, deep_base=False, stem_width=8):
        self.inplanes = stem_width * 2 if deep_base else 16

        super(ResNet, self).__init__()
        if deep_base:
            self.conv1 = nn.Sequential(
                nn.Conv2d(3, stem_width, kernel_size=5, stride=2, padding=2, bias=False),
